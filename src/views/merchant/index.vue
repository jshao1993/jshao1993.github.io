<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.name" placeholder="输入商家名称" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    >
        ...
        <template slot-scope="props">
          <el-form label-position="left" inline class="table-expand">
            ...
            <el-form-item label="联系人">
              <span>{{ props.row.phonePerson }}</span>
            </el-form-item>
      ...
      <el-table-column prop="name" label="商家名称" width="180px" align="center" />
      <el-table-column prop="phonePerson" label="联系人" min-width="180px" align="center" />
      <el-table-column prop="phone" label="联系人手机号" width="180px" align="center" />
      <el-table-column prop="registerTime" label="注册时间" width="180px" align="center" />
      <el-table-column prop="dueTime" label="到期时间" width="150px" align="center" />
      <el-table-column prop="status" label="状态" width="150px" align="center">
        <template slot-scope="{row}">
          <el-tag :type="row.status | statusFilter">
            {{ row.status | statusFilter | statusFilter }}
          </el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="money" label="充值金额" width="150px" align="center">
        <template slot-scope="{row}">
          <el-link :type="row.status | statusFilter" :underline="false">
            {{ row.money }}
          </el-link>
        </template>
      </el-table-column>
    ...
    <el-dialog width="540px" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" @closed="beforeClose">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="120px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="联系人" prop="phonePerson">
          <el-input v-model="temp.phonePerson" clearable placeholder="请输入联系人" />
        </el-form-item>
        <el-form-item label="联系人手机号" prop="phone">
          <el-input v-model="temp.phone" clearable placeholder="请输入联系人手机号" />
        </el-form-item>
        <el-form-item label="注册时间" prop="registerTime">
          <el-date-picker v-model="temp.registerTime" type="date" placeholder="请选择注册时间" style="width: 100%;" />
        </el-form-item>
        <el-form-item label="到期时间" prop="dueTime">
          <el-date-picker v-model="temp.dueTime" type="date" placeholder="请选择到期时间" style="width: 100%;" />
        </el-form-item>
